...
export const REVIEWS_DATA: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    title: '결혼정보회사 상담받고 현타왔는데 러브매칭이 정답이었네요',
    content:
      '결정사 가입비 300만원 부르고 등급 매기는 게 너무 거부감 들었거든요. 러브매칭은 2만원대 참가비에 재직증명서랑 싱글 인증 다 확인된 진짜 괜찮은 직장인 분들만 나와서 놀랐습니다. 10명과 진솔하게 이야기 나누며 이상형을 찾을 수 있어서 가성비 최고입니다.',
    matched: true,
    date: '2026.09.03',
    badge: '성혼 예정 💍',
  },
...
export const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer:
      '러브매칭은 2030 싱글 직장인을 대상으로 하며, 참가 신청 시 명함/사원증/건강보험자격득실확인서 등을 통해 직장 인증과 싱글(미혼) 확인을 100% 거칩니다. 신원이 불분명하거나 기혼자의 참가는 법적으로 엄격히 제한됩니다.',
  },
  {
    id: 'faq-2',
    category: '진행 방식',
  ...
  },
  {
    ...
    answer:
      '아닙니다! 러브매칭은 참가자 보호를 위해 현장에서의 직접적인 연락처 교환을 지양합니다. 행사가 끝난 뒤 모바일 안심 쪽지 매칭표를 통해 호감 있는 상대 1~3지망을 비밀리에 제출하며, 서로 호감을 표현한 분들에 한해 익일 오전 매니저가 연락처를 전달해 드립니다.',
  },
  {
    id: 'faq-4',
    category: '진행 방식',
...
export const TRUST_STATS = [
  ...
  { label: '누적 성혼 커플', value: '320쌍+', desc: '러브매칭을 통해 결혼에 골인한 커플' },
