...
export const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer:
      '소개남녀는 2030 싱글 직장인을 대상으로 하며, 참가 신청 시 본인 사진 등록 및 명함/사원증/건강보험자격득실확인서 등을 통해 직장 인증과 싱글(미혼) 확인 절차를 거칩니다. 신원이 불분명하거나 기혼자의 참가는 엄격히 제한됩니다.',
  },
  {
    id: 'faq-2',
    category: '진행 방식',
...
export const TRUST_STATS = [
  ...
  { label: '평균 매칭률', value: '42.8%', desc: '상호 수락 기준 매칭 성사율' },
  { label: '누적 매칭 성공', value: '3,200쌍+', desc: '소개남녀를 통해 연결된 커플' },
  { label: '정기 매칭 지역', value: '5개 핫플', desc: '흑석·서교·합정·홍대·신도림' },
];
...
export const SAMPLE_MALE_CARD = {
  ...
  profileImage: '/images/sample_male.jpg',
};
...
export const SAMPLE_FEMALE_CARD = {
  ...
  jobRole: '서비스 기획자',
  mbti: 'ENFJ',
  personality: '밝고 긍정적인 에너지를 좋아하며, 경청과 리액션이 좋은 다정한 성격입니다.',
  bodyTypeFeature: '슬림탄탄',
  hobbiesSpecialty: '전시회 관람, 필라테스, 베이킹',
  eyelid: '유쌍' as const,
  smoking: '비흡연' as const,
  drinkingCapacity: '맥주 1~2잔',
  religion: '무교',
  ...
  profileImage: '/images/sample_female.jpg',
};
