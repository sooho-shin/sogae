    ...
    <div className="min-h-screen bg-[#FAFAFC] text-neutral-900 pb-20 md:pb-0">
      ...
      <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-28 bg-gradient-to-b from-purple-900 via-[#331B54] to-[#1E0F33] text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            {/* Main Headline (Lovematching Benchmark Copy) */}
      ...
      <section className="py-16 md:py-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-neutral-200/80 shadow-xs flex flex-col justify-between">
            <div>
            ...
            <div className="pt-6 mt-6 border-t border-neutral-100 text-xs text-neutral-600">
              만남 성사율 낮음 / 신원 검증 불투명
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-6 relative">
            {HOW_IT_WORKS_STEPS.map((step, idx) => (
              <div
                key={idx}
                className="relative bg-neutral-50 hover:bg-purple-50/50 rounded-2xl p-5 border border-neutral-200/80 hover:border-purple-300 transition-all group flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-white text-[#623898] border border-purple-200">
                      {step.badge}
                    </span>
                  </div>
          ...
          {filteredSessions.map((session) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-neutral-100 flex items-center justify-between">
                <div>
                  <span className="text-xs text-neutral-600 line-through mr-1.5">
                ...
                <Link
                  href={`/apply?sessionId=${session.id}`}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-white/10 space-y-4">
              ...
              <h3 className="text-lg font-bold text-white">1. 직장 및 재직 100% 검증</h3>
              <p className="text-xs sm:text-sm text-neutral-300 leading-relaxed">
                명함, 사원증, 재직증명서, 회사 웹메일 인증 중 하나를 필수로 거칩니다.
                무직이나 신원 미상의 참가는 불가능합니다.
              </p>
            </div>
